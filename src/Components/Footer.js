    ...
    <div className="containerFooter">
      <footer className="py-3 my-4">
        <ul className="nav justify-content-center border-bottom pb-3 mb-3">
          ...
          <li className="nav-item"><a href="/animes" className="nav-link px-2 text-body-secondary">Anime's</a></li>
          <li className="nav-item"><a href="/suscriptores" className="nav-link px-2 text-body-secondary">Subscribers</a></li>
        </ul>
